...
document.addEventListener('DOMContentLoaded', function() {
    new Typed('.home_title #subtitle', {
        strings: ['delivers solutions.', 'is a team player.', 'provides an engaging experience to customers.', 'has experience with various technologies.', 'has a passion for programming.'],
        typeSpeed: 50,
        backSpeed: 20,
        smartBackspace: true,
        loop: true
    ...
    $('.popup-link').magnificPopup({
        ...
        image: {
            titleSrc: function(item) {
                return item.el.attr('title') + '<small>by Sergio Gutierrez</small>';
            }
        }
    });
